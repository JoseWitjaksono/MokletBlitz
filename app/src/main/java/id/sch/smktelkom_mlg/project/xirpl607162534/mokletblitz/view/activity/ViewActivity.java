package id.sch.smktelkom_mlg.project.xirpl607162534.mokletblitz.view.activity;
...
import id.sch.smktelkom_mlg.project.xirpl607162534.mokletblitz.BaseAPI;
import id.sch.smktelkom_mlg.project.xirpl607162534.mokletblitz.R;
import id.sch.smktelkom_mlg.project.xirpl607162534.mokletblitz.model.ModelPhoto;
import id.sch.smktelkom_mlg.project.xirpl607162534.mokletblitz.view.adapter.MainAdapter;
...
//        CEK DATA LOKAL
        ...
        if (photos.size() <= 0){
            ...
            MainAdapter adapter = new MainAdapter(ViewActivity.this, photos);
    ...
    private void loadPhoto(){
        ...
        photoList.enqueue(new Callback<List<ModelPhoto>>() {
            ...
            public void onResponse(Call<List<ModelPhoto>> call, Response<List<ModelPhoto>> response) {
                MainAdapter adapter = new MainAdapter(ViewActivity.this, response.body());
                listView.setAdapter(adapter);
                closeProgress();
